...
public class DelaPazA_ProjectPrelims extends Frame {
    ...
    public static void main(String[] args) {
        Frame frame = new DelaPazA_ProjectPrelims();
        frame.setTitle("Dela Paz, Angelo - Self Portrait");
        frame.setSize(600, 1000);
        frame.setBackground(new Color(14, 17, 17));
